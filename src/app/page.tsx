  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col">
        <section
          className="flex max-w-screen min-h-banner sm:min-h-screen"
          id="hero"
        >
          <div className="flex flex-1 flex-col gap-8 justify-center pl-8 sm:pl-20">
            <h2 className="text-4xl sm:text-3xl md:text-4xl lg:text-6xl text-white font-black">
          ...
          <div className=" hidden lg:flex flex-1 justify-center items-center flex-col bg-contrast rounded-tl-full rounded-bt-full ">
        ...
        <section
          className="flex flex-col max-w-screen min-h-banner px-7 pb-8 sm:min-h-screen sm:px-8 lg:px-20 lg:pt-20 gap-8"
          id="activities"
        >
